...
sce1 = sce.selectcells(sce.c_batch_id=="GSM3308547");
sce2 = sce.selectcells(sce.c_batch_id=="GSM3308548");
sce1 = sce1.qcfilter;
sce2 = sce2.qcfilter;
...
[T1, X1, g1, xyz1] = sc_splinefit(full(X1_ori), g_ori, true, false);
[T1, idx1] = sortrows(T1,'genes','ascend');
X1 = X1(idx1, :);
g1 = g1(idx1);


[T2, X2, g2, xyz2] = sc_splinefit(full(X2_ori), g_ori, true, false);
